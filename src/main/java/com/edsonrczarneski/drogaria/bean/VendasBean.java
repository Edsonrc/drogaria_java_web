	...
	public void salvar() {
		try {
			if (venda.getPrecoTotal().signum() == 0) {
				Messages.addGlobalInfo("Por favor, informe pelo menos um produto para a venda!");
			}
